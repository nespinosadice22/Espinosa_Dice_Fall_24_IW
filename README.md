...
1) Data: contains final data used, in addition to preprocessing code. This data was aggreated from several sources (CEDE, Colombian National Police Department, DANE, UNODC, GDL and Monitor Ciudadano). 
...
- Models include a random forest model, ridge regression model and a support vector machine.
